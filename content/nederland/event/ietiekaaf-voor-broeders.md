...
description : ""
# Event image
image: "images/events/iktikaf-rotterdam.webp"
# location
...
<style>
  ...
  .ppme-wrap {
    ...
    max-width: 680px;
    margin: 0 auto;
    background: linear-gradient(160deg, #dce9f8 0%, #c5d8f2 100%);
    border-radius: 20px;
    overflow: hidden;
    box-shadow: 0 12px 48px rgba(10,30,80,0.22), 0 2px 8px rgba(10,30,80,0.1);
    border: 1px solid rgba(255,255,255,0.6);
  }

  /* ── HEADER ── */
  .ppme-header {
    background: linear-gradient(135deg, var(--pp-blue-dark) 0%, var(--pp-blue-mid) 60%, var(--pp-blue-light) 100%);
  ...
  .ppme-date { margin-top: 0.8rem; position: relative; }
  .ppme-date p { font-size: 0.9rem; color: rgba(255,255,255,0.85); font-weight: 500; }
  .ppme-date strong {
    display: block;
    font-size: clamp(0.9rem, 3vw, 1.05rem);
    color: var(--pp-gold-light); font-weight: 700; margin-top: 0.15rem;
  }

  /* ── TABLE ── */
  .ppme-table-wrap { padding: 0.5rem; }
  .ppme-wrap table {
    width: 100%;
    border-collapse: separate;
    border-spacing: 0 4px;
  }
  .ppme-wrap thead tr th {
  ...
  .ppme-wrap thead tr th:first-child { border-radius: 8px 0 0 8px; }
  .ppme-wrap thead tr th:last-child  { border-radius: 0 8px 8px 0; }

  .ppme-wrap tbody tr { transition: transform 0.15s ease, box-shadow 0.15s ease; }
  .ppme-wrap tbody tr:hover {
    transform: translateY(-1px);
    box-shadow: 0 4px 14px rgba(10,30,80,0.15);
  }
  .ppme-wrap tbody tr:nth-child(odd)  td { background: var(--pp-row-odd); }
  .ppme-wrap tbody tr:nth-child(even) td { background: var(--pp-row-even); }
  .ppme-wrap tbody tr.pp-prayer td    { background: linear-gradient(90deg, #c4d4ec, #bdd0ef); }
  .ppme-wrap tbody tr.pp-prayer td.pp-time { color: var(--pp-gold); font-weight: 800; }
  ...
  .ppme-wrap td:first-child { border-radius: 8px 0 0 8px; }
  .ppme-wrap td:last-child  { border-radius: 0 8px 8px 0; }

  .ppme-wrap td.pp-time {
    font-weight: 800;
  ...
  .ppme-wrap tr.pp-prayer .pp-dot { background: var(--pp-gold); }

  .ppme-wrap td.pp-act { font-weight: 500; }
  .ppme-wrap td.pp-act em {
    font-style: normal;
  ...
  @media (max-width: 420px) {
    .ppme-wrap td.pp-time { width: 4.2rem; min-width: 4rem; font-size: 0.82rem; }
    .ppme-wrap td { padding: 0.6rem 0.7rem; }
  }
</style>
...
<div class="ppme-wrap">
  ...
  <div class="ppme-footer">
    <span class="ppme-badge">PPME Cabangs Nederland</span>
    <span class="ppme-badge">Majelis Da'i Muda</span>
    <span class="ppme-badge">Al Fath</span>
    <span class="ppme-badge">TenggaraPulse</span>
  </div>
